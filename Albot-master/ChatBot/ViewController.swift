...
class ViewController: MessagesViewController, NVActivityIndicatorViewable {
    ...
    // Users
    var current = Sender(id: "123456", displayName: "Angel")
    let watson = Sender(id: "654321", displayName: "Albert")
    ...
    func instantiateAssistant() {
        ...
        startAnimating( message: "Connecting to Albert", type: NVActivityIndicatorType.ballScaleRipple)
        ...
        if let workspaceID = configuration["workspaceID"] as? String {
            ...
            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 1.5) {
                ...
                // checking for training was here before
    ...
    func retrieveFirstMessage() {
        ...
        DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 1.5) {
            NVActivityIndicatorPresenter.sharedInstance.setMessage("Talking to Albert...")
        }
    ...
    func getAvatarFor(sender: Sender) -> Avatar {
        switch sender {
        case current:
            return Avatar(image: UIImage(named: "avatar_small"), initials: "AR")
        case watson:
            return Avatar(image: UIImage(named: "watson_avatar"), initials: "EIN")
        default:
            return Avatar()
        }
    }
